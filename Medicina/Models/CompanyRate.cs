...
namespace Medicina.Models
{
    public class CompanyRate
    {
        ...
        public CompanyRate(int id, bool highQuality, bool lowQuality, bool cheap, bool expensive, bool wideSelection, bool limitedSelection, string description, int companyId)
        {
            Id = id;
